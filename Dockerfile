...
RUN apt-get -y update \
    ...
    python3-setuptools python3-wheel jq whois nano vim pv ipcalc lolcat unzip ccze zip procps \
...
# Create /tools dir saving custom tools
RUN mkdir -p /tools

# Install Python libraries using PIP
RUN pip3 install urllib3 pyfiglet requests
